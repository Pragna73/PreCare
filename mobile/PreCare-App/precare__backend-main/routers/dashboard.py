...
def user_dashboard(
    ...
    is_active_critical = bool(emergency and last_report and last_report.risk_level in ("DANGER", "CRITICAL"))
    ...
    return {
        ...
        "emergency_status": "Ambulance on the way" if is_active_critical else "No active emergency",
    }
