...
struct User: Codable, Identifiable {
    ...
    init(id: String, fullName: String, email: String, role: UserRole = .patient, phoneNumber: String? = nil, emergencyContact: String? = nil, createdAt: Date? = nil) {
        self.id = id
    ...
    init?(json: [String: Any]) {
        ...
        self.emergencyContact = APIClient.readString(json, keys: ["emergency_contact", "emergencyContact", "emergency_phone"])
